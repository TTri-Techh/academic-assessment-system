                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($teachers as $teacher): ?>
                                            <tr>
                                                ...
                                                <td><?= htmlspecialchars($teacher['father_name']) ?> <br>
                                                    <?= htmlspecialchars($teacher['mother_name']) ?> </td>
                                                ...
                                                <td><span
                                                        class="badge <?= $teacher['status'] == 'active' ? 'bg-success' : 'bg-danger' ?> "><?= htmlspecialchars($teacher['status']) ?></span>
                                                </td>
                                                <td><?= htmlspecialchars($teacher['phone']) ?> <br>
                                                    <?= htmlspecialchars($teacher['address']) ?></td>
                                                <td class="d-flex align-items-center">
                                                    <!-- </button> -->
                                                    <a class=""
                                                        href="edit-teacher.php?id=<?= htmlspecialchars($teacher['id']) ?>"><i
                                                            data-feather="edit-2" class="icon-sm me-2"></i></a>
                                                    <a class="" href="javascript:;"
                                                        onclick="<?= AlertHelper::confirmDelete($teacher['id'], 'Do you want to delete this teacher?', 'view-teachers.php?delete=true&id='); ?>">
