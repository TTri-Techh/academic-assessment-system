                            ...
                            <form id="signupForm" method="POST" action="">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="mb-3">
                                            <label for="name_my" class="form-label">အမည်(မြန်မာ)</label>
                                            <input id="name_my" class="form-control" name="name_my" type="text"
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                <label for="phone_number" class="form-label">ဖုန်းနံပါတ်</label>
